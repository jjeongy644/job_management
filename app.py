...
if "companies" not in st.session_state:
    st.session_state.companies = pd.DataFrame([
        {"연번": 1, "등록일자": "2026-06-01", "기업명": "수완에너지(주)", "구분": "중견기업", "채용직무": "운영 파트", "HR성명": "김담당", "HR직급": "대리", "HR내선": "062-123-4567", "HR휴대폰": "010-1234-5678", "HRe-mail": "hr@suwan.com", "공고시기": "2026-06", "진행상태": "마감"},
        {"연번": 2, "등록일자": "2026-07-01", "기업명": "㈜하림산업", "구분": "대기업(계열사)", "채용직무": "환경자원팀", "HR성명": "김인사", "HR직급": "팀장", "HR내선": "063-123-4567", "HR휴대폰": "010-1234-5678", "HRe-mail": "hr@harim.com", "공고시기": "2026-07", "진행상태": "마감"},
        {"연번": 3, "등록일자": "2026-08-05", "기업명": "서울시니어스타워", "구분": "우수기업", "채용직무": "사회복지/행정", "HR성명": "이인사", "HR직급": "팀장", "HR내선": "02-987-6543", "HR휴대폰": "010-9876-5432", "HRe-mail": "personnel@seniortower.co.kr", "공고시기": "2026-08", "진행상태": "진행중"}
    ])

if "applicants" not in st.session_state:
    st.session_state.applicants = pd.DataFrame([
        {"연번": 1, "지원일자": "2026-06-10", "학번": "20201234", "학생명": "김철수", "학과": "전기공학과", "학적": "재학", "연락처": "010-1111-2222", "이메일": "chulsoo@chosun.ac.kr", "학점": 3.6, "지원기업": "수완에너지(주)", "지원직무": "운영 파트", "상태": "최종합격"},
        {"연번": 2, "지원일자": "2026-07-15", "학번": "20205678", "학생명": "이영희", "학과": "환경공학과", "학적": "재학", "연락처": "010-2222-3333", "이메일": "yh@chosun.ac.kr", "학점": 3.8, "지원기업": "㈜하림산업", "지원직무": "환경자원팀", "상태": "최종합격"},
        {"연번": 3, "지원일자": "2026-08-10", "학번": "20219999", "학생명": "박민수", "학과": "사회복지학과", "학적": "졸업예정", "연락처": "010-3333-4444", "이메일": "minsu@chosun.ac.kr", "학점": 3.2, "지원기업": "서울시니어스타워", "지원직무": "사회복지/행정", "상태": "추천완료"}
    ])
...
if "passed" not in st.session_state:
    st.session_state.passed = pd.DataFrame([
        ...
        {"연번": 2, "합격일자": "2026-07-30", "학번": "20205678", "이름": "이영희", "학과": "환경공학과", "연락처": "010-2222-3333", "기업명": "㈜하림산업", "직무": "환경자원팀", "입사일": "2026-08-01", "재직상태": "재직중", "멘토가능여부": True, "비고": "환경기사 보유"}
    ])
...
def create_template(target_type):
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        if target_type == "등록 기업 목록":
            df_tpl = pd.DataFrame([{"연번": 1, "등록일자": "2026-08-01", "기업명": "예시기업(주)", "구분": "중견기업", "채용직무": "경영지원", "HR성명": "홍길동", "HR직급": "과장", "HR내선": "02-123-4567", "HR휴대폰": "010-0000-0000", "HRe-mail": "hr@example.com", "공고시기": "2026-08", "진행상태": "진행중"}])
            df_tpl.to_excel(writer, sheet_name='등록기업_양식', index=False)
        elif target_type == "지원 학생 목록":
            df_tpl = pd.DataFrame([{"연번": 1, "지원일자": "2026-08-01", "학번": "20230001", "학생명": "홍길동", "학과": "경영학과", "학적": "재학", "연락처": "010-0000-0000", "이메일": "example@chosun.ac.kr", "학점": 3.8, "지원기업": "예시기업(주)", "지원직무": "경영지원", "상태": "접수"}])
